...
/* =========================
   ...
   CORREGIDO: Eliminado p.num_empleado (no existe)
   Se usa p.id_personal formateado como número de empleado
========================= */
$sql_asignados = "
    SELECT 
        a.id_asignacion,
        ...
        p.id_personal,
        -- Generar número de empleado a partir del ID (formato EMP00001)
